...
import { DeliveryForm } from "@/components/programs/delivery-form";
...
export default async function NewServiceDeliveryPage({
  searchParams,
}: NewDeliveryPageProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-slate-900">Record service delivery</h2>
        <p className="mt-1 text-sm text-slate-600">
          Service type and optional program are selected from active catalog records.
        </p>
      </div>
